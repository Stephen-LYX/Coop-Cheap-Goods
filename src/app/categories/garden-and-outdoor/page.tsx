      ...
      <div className="flex">
        ...
        <div className="flex-1">
          <div className="px-4 py-6">
            <Breadcrumb items={[{ label: "Garden & Outdoor" }]} />
            <h1 className="text-3xl font-bold text-gray-900 mb-6">Garden & Outdoor</h1>
            <MarketplaceGrid category="Garden & Outdoor" sportsFilters={filters} />
          </div>
        </div>
      </div>
    </main>
