...
import BeautyFilters, {
  BeautyFilterState,
} from "@/component/BeautyFilters";
...
export default function BeautyHealthPage() {
  ...
  const handleFilterChange = (newFilters: BeautyFilterState) => {
      ...
      <div className="flex">
        ...
        <div className="flex-1">
          <div className="px-4 py-6">
            <Breadcrumb items={[{ label: "Beauty & Health" }]} />
            <h1 className="text-3xl font-bold text-gray-900 mb-6">
              Beauty & Health
            </h1>
            <MarketplaceGrid category="Beauty & Health" beautyFilters={filters} />
          </div>
        </div>
      </div>
    </main>
