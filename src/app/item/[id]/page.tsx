...
export default async function Item({
  ...
  try {
    ...
    const { data: seller_rating, error: seller_ratingError } = await supabase
      .from("seller_reviews")
      .select("rating.avg()")
      .eq("seller", "00000000-0000-0000-0000-000000000002");
            ...
            <div className="flex-auto pl-4 w-100">
              ...
              <div className="flex">
                ...
                <div className="ml-2">
                  ...
                  <a href="">
                    {seller_rating.map((rating) => {
                      //build array for rating stars
                      const sellerReviewStars = [];
                      for (let i = 1; i <= 5; i++) {
                        let value;
                        if (rating.avg >= 1) {
                          value = 1;
                        ...
                        sellerReviewStars.push({ id: i, value: value });
                        rating.avg--;
                      }
