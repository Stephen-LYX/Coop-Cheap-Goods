...
export interface GardenOutdoorFilterState {
  priceRange: { min: number; max: number } | null;
  conditions: string[];
}

interface GardenOutdoorFiltersProps {
  onFilterChange: (filters: GardenOutdoorFilterState) => void;
  availableFilters: {
    conditions: string[];
  };
}

const GardenOutdoorFilters = ({
  onFilterChange,
  availableFilters,
}: GardenOutdoorFiltersProps) => {
  const [pendingFilters, setPendingFilters] =
    useState<GardenOutdoorFilterState>({
  ...
  const toggleFilter = (
    category: keyof Omit<GardenOutdoorFilterState, "priceRange">,
    value: string,
  ) => {
...
export default GardenOutdoorFilters;
