...
export interface BeautyHealthFilterState {
  priceRange: { min: number; max: number } | null;
  conditions: string[];
}

interface BeautyHealthFiltersProps {
  onFilterChange: (filters: BeautyHealthFilterState) => void;
  availableFilters: {
    conditions: string[];
  };
}

const BeautyHealthFilters = ({
  onFilterChange,
  availableFilters,
}: BeautyHealthFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<BeautyHealthFilterState>(
    {
  ...
  const toggleFilter = (
    category: keyof Omit<BeautyHealthFilterState, "priceRange">,
    value: string,
  ) => {
...
export default BeautyHealthFilters;
