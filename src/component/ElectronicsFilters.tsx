...
const ElectronicsFilters = ({ onFilterChange, availableFilters }: ElectronicsFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<ElectronicsFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<ElectronicsFilterState, 'priceRange'>, value: string) => {
