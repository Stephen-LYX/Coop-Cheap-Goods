...
interface ClothingFiltersProps {
  onFilterChange: (filters: ClothingFilterState) => void
  availableFilters: {
    brands: string[]
    sizes: string[]
    colors: string[]
...
const ClothingFilters = ({ onFilterChange, availableFilters }: ClothingFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<ClothingFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<ClothingFilterState, 'priceRange'>, value: string) => {
