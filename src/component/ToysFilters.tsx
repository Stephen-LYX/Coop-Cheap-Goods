...
export interface ToysFilterState {
  brands: string[]
  priceRange: { min: number; max: number } | null
  conditions: string[]
}

interface ToysFiltersProps {
  onFilterChange: (filters: ToysFilterState) => void
  availableFilters: {
    brands: string[]
    conditions: string[]
  }
...
const ToysFilters = ({ onFilterChange, availableFilters }: ToysFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<ToysFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<ToysFilterState, 'priceRange'>, value: string) => {
