...
export interface HomeKitchenFilterState {
  brands: string[]
...
interface HomeKitchenFiltersProps {
  onFilterChange: (filters: HomeKitchenFilterState) => void
  availableFilters: {
    brands: string[]
    colors: string[]
    conditions: string[]
...
const HomeKitchenFilters = ({ onFilterChange, availableFilters }: HomeKitchenFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<HomeKitchenFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<HomeKitchenFilterState, 'priceRange'>, value: string) => {
...
export default HomeKitchenFilters
