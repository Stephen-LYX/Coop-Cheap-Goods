...
interface FurnitureFiltersProps {
  onFilterChange: (filters: FurnitureFilterState) => void
  availableFilters: {
    brands: string[]
    sizes: string[]
    colors: string[]
...
const FurnitureFilters = ({ onFilterChange, availableFilters }: FurnitureFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<FurnitureFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<FurnitureFilterState, 'priceRange'>, value: string) => {
