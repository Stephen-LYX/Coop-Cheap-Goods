...
export interface MusicalInstrumentsFilterState {
  brands: string[]
  priceRange: { min: number; max: number } | null
  conditions: string[]
}

interface MusicalInstrumentsFiltersProps {
  onFilterChange: (filters: MusicalInstrumentsFilterState) => void
  availableFilters: {
    brands: string[]
    conditions: string[]
  }
...
const MusicalInstrumentsFilters = ({ onFilterChange, availableFilters }: MusicalInstrumentsFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<MusicalInstrumentsFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<MusicalInstrumentsFilterState, 'priceRange'>, value: string) => {
...
export default MusicalInstrumentsFilters
