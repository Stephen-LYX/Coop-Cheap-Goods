...
const BooksFilters = ({ onFilterChange, availableFilters }: BooksFiltersProps) => {
  const [pendingFilters, setPendingFilters] = useState<BooksFilterState>({
    brands: [],
  ...
  const toggleFilter = (category: keyof Omit<BooksFilterState, 'priceRange'>, value: string) => {
  ...
  return (
    <div className="w-64 bg-white border-r border-gray-200 h-full overflow-y-auto">
      <div className="p-4">
        ...
        {/* Brand Filter */}
        <FilterSection title="Publisher/Author" section="brand">
