        ...
        <div className="md:hidden pb-4">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-l-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
            <button className="absolute right-0 top-0 bottom-0 bg-blue-600 hover:bg-blue-700 text-white px-4 rounded-r-full">
              <SearchIcon />
            </button>
          </div>
        </div>
          ...
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            {NAV_LINKS.map((link) => (
              ...
              >
                ...
                {link.key === 'notifications' && (
                  <span className="bg-red-500 text-white text-xs rounded-full h-2 w-2 ml-auto"></span>
                )}
              </Link>
            ))}
          </div>
